...
#include "ngraph_transformations/op/rnn_prim.hpp"

namespace ov {
namespace intel_cpu {
namespace node {

class RNN2 : public Node {
public:
    RNN2(const std::shared_ptr<ngraph::Node>& op, const mkldnn::engine& eng, WeightsSharing::Ptr &cache);
...
private:
    ...
    */
    ...
    size_t L = 1;   /**< What is it??. Constant for mkldnn impl */
